...
if use_dino:
    ...
    num_features = cnn.head.in_features  # Get the number of input features from the classifier head
    cnn.head = nn.Linear(num_features, 8)  # Assuming output size is 8 for steering angle prediction
else:
    # Use custom model
